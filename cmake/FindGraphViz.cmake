...
if(GRAPHVIZ_CDT_LIBRARY)
  list(APPEND GRAPHVIZ_LIBRARIES ${GRAPHVIZ_CDT_LIBRARY})
endif()

find_library(GRAPHVIZ_GVC_LIBRARY      NAMES gvc 
             HINTS ${_GRAPHVIZ_LIBRARY_DIR})
if(GRAPHVIZ_GVC_LIBRARY)
  list(APPEND GRAPHVIZ_LIBRARIES ${GRAPHVIZ_GVC_LIBRARY})
endif()

find_library(GRAPHVIZ_CGRAPH_LIBRARY   NAMES cgraph
             HINTS ${_GRAPHVIZ_LIBRARY_DIR})
if(GRAPHVIZ_CGRAPH_LIBRARY)
  list(APPEND GRAPHVIZ_LIBRARIES ${GRAPHVIZ_CGRAPH_LIBRARY})
endif()

find_library(GRAPHVIZ_PATHPLAN_LIBRARY NAMES pathplan
             HINTS ${_GRAPHVIZ_LIBRARY_DIR})
if(GRAPHVIZ_PATHPLAN_LIBRARY)
  list(APPEND GRAPHVIZ_LIBRARIES ${GRAPHVIZ_PATHPLAN_LIBRARY})
endif()
